...
def executive(state, stateabbrev, county):
    ...
    states = classDumpModule5.read_states()
    'Module 5 Input Path'
    fileLocation = rootFilePath + 'Module 5\\' + state + '\\' + state + '_' + county + '_' +  inputFileNameSuffix
    'Module 5 MODAL Output Path'
    outputLocation = rootFilePath + 'Module 5 MODE\\' + outputFileNameSuffix
