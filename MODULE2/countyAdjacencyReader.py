...
and reads in the Journey-to-Work Census and formats it for use in py.py. All of these functions are helper
functions for py.py which is the bulk execution of module 2.
...
class j2wDist:
    ...
    'SELECT A WORK COUNTY BY CREADING A CDF'
    def select(self):
